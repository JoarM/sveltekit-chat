<script lang="ts">
    ...
    let sortedEmojis = $emojis.sort(function(a, b){return a.id - b.id});
</script>

<div class="flex flex-col justify-end bg-slate-900 gap-1 p-1">
    <button class="selectorButtons">
...
<div class="category-wrapper">
    {#each sortedEmojis as category}
        <details open={true}>
            <summary class="capitalize text-sm cursor-pointer md:opacity-75 md:hover:opacity-100 transition-opacity duration-100">{category.name}</summary>
...
<style lang="scss">
    .inner-emojis {
        @apply flex flex-wrap mr-4 w-full;
    }
